...
const Privacy = () => {
  ...
  const baseUrl = config.base_url || "https://ya-magazine.com"
    ...
    <Layout>
      <ArticleLayout>
        <Meta
          ...
          description={`Privacy and policy of ${siteName}`}
        />
        <Container>
          ...
          <Text>
            At {siteName}, accessible from {baseUrl}, one of our main priorities
          ...
          <Text>
            ...
            that they shared and/or collect in {siteName}. This policy is not
        ...
        <Container>
          ...
          <Text>
            ...
            advertising partners of {siteName}.
          </Text>

          <Text>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on {siteName}, which
          ...
          <Text>
            Note that {siteName} has no access to or control over these cookies
        ...
        <Container>
          ...
          <Text>
            {siteName}'s Privacy Policy does not apply to other advertisers or
